...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\ContatosType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ContatosType']) ? $this->services['AppBundle\Form\ContatosType'] : $this->services['AppBundle\Form\ContatosType'] = new \AppBundle\Form\ContatosType()) && false ?: '_'};
