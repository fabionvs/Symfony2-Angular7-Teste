 ...
 */
class Contatos extends \AppBundle\Entity\Contatos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Contatos' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Contatos' . "\0" . 'nome', '' . "\0" . 'AppBundle\\Entity\\Contatos' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Contatos' . "\0" . 'telefone'];
        }
